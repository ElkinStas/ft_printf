...
{
<<<<<<< HEAD
float k = 2.5473219880;
int u = 72;
/*
printf("kolichestvo %d\n", printf("01 stroka: %+8.6f\n", k));
printf("kolichestvo %d\n", ft_printf("01 stroka: %+8.6f\n", k));
printf("kolichestvo %d\n", printf("02 stroka: % -8.6f\n", k));
printf("kolichestvo %d\n", ft_printf("02 stroka: % -8.6f\n", k));
printf("kolichestvo %d\n", printf("03 stroka: %15.3f\n", k));
printf("kolichestvo %d\n", ft_printf("03 stroka: %15.3f\n", k));
printf("kolichestvo %d\n", printf("04 stroka: %-15.3f\n", k));
printf("kolichestvo %d\n", ft_printf("04 stroka: %-15.3f\n", k));
printf("kolichestvo %d\n", printf("05 stroka: %-15.8f\n", k));
printf("kolichestvo %d\n", ft_printf("05 stroka: %-15.8f\n", k));
printf("kolichestvo %d\n", printf("06 stroka: %10f\n", k));
printf("kolichestvo %d\n", ft_printf("06 stroka: %10f\n", k));
printf("kolichestvo %d\n", printf("07 stroka: %010f\n", k));
printf("kolichestvo %d\n", ft_printf("07 stroka: %010f\n", k));
printf("kolichestvo %d\n", printf("08 stroka: %0 12.2f\n", k));
printf("kolichestvo %d\n", ft_printf("08 stroka: %0 12.2f\n", k));
printf("kolichestvo %d\n", printf("09 stroka: % 12.6f\n", k));
printf("kolichestvo %d\n", ft_printf("09 stroka: % 12.6f\n", k));
printf("kolichestvo %d\n", printf("10 stroka: %11.0f\n", k));
printf("kolichestvo %d\n", ft_printf("10 stroka: %11.0f\n", k));
printf("kolichestvo %d\n", printf("11 stroka: %4.7f\n", k));
printf("kolichestvo %d\n", ft_printf("11 stroka: %4.7f\n", k));
printf("kolichestvo %d\n", printf("12 stroka: %-4.6f\n", k));
printf("kolichestvo %d\n", ft_printf("12 stroka: %-4.6f\n", k));
printf("kolichestvo %d\n", printf("13 stroka: %+9f\n", k));
printf("kolichestvo %d\n", ft_printf("13 stroka: %+9f\n", k));
//printf("kolichestvo %d\n", printf("%+ 8f\n", k));*/

int r = 67;
  printf("kolichestvo %d\n", ft_printf("02 stroka: %llhhll10.3u\n", r));
...
<<<<<<< HEAD
	 printf("kolichestvo %d\n", printf("05 stroka: % 015.2s\n", str));
	 printf("kolichestvo %d\n", ft_printf("05 stroka: % 015.2s\n", str));
=======
...
printf("kolichestvo %d\n", ft_printf("05 stroka: % 015p\n", str));
	...
	printf("kolichestvo %d\n", ft_printf("07 stroka: %16.12p\n", str));
	 //тесты для count
<<<<<<< HEAD
	printf("kolichestvo %d\n", printf("01 stroka: %-+8.6u\n", -123));
	printf("kolichestvo %d\n", ft_printf("01 stroka: %-+8.6u\n", -123));
	printf("kolichestvo %d\n", printf("02 stroka: % -+8.6u\n", -123));
	printf("kolichestvo %d\n", ft_printf("02 stroka: % -+8.6u\n", -123));
	printf("kolichestvo %d\n", printf("03 stroka: %-+8.6u\n", 123));
	printf("kolichestvo %d\n", ft_printf("03 stroka: %-+8.6u\n", 123));
	printf("kolichestvo %d\n", printf("04 stroka: % -+8.6u\n", 123));
	printf("kolichestvo %d\n", ft_printf("04 stroka: % -+8.6u\n", 123));
	printf("kolichestvo %d\n", printf("05 stroka: %-8.6u\n", 123));
	printf("kolichestvo %d\n", ft_printf("05 stroka: %-8.6u\n", 123));
	printf("kolichestvo %d\n", printf("06 stroka: % -8.6u\n", 123));
	printf("kolichestvo %d\n", ft_printf("06 stroka: % -8.6u\n", 123));
	printf("kolichestvo %d\n", printf("07 stroka: %+8.6u\n", -123));
	 printf("kolichestvo %d\n", ft_printf("07 stroka: %+8.6u\n", -123));
	 printf("kolichestvo %d\n", printf("08 stroka: % +8.6u\n", -123));
	 printf("kolichestvo %d\n", ft_printf("08 stroka: % +8.6u\n", -123));
	 printf("kolichestvo %d\n", printf("09 stroka: %+8.6u\n", 123));
	 printf("kolichestvo %d\n", ft_printf("09 stroka: %+8.6u\n", 123));
	 printf("kolichestvo %d\n", printf("10 stroka: % +8.6u\n", 123));
	 printf("kolichestvo %d\n", ft_printf("10 stroka: % +8.6u\n", 123));
	 printf("kolichestvo %d\n", printf("11 stroka: %8.6u\n", 123));
	 printf("kolichestvo %d\n", ft_printf("11 stroka: %8.6u\n", 123));
	 printf("kolichestvo %d\n", printf("12 stroka: % 8.6u\n", 123));
	 printf("kolichestvo %d\n", ft_printf("12 stroka: % 8.6u\n", 123));
	 printf("kolichestvo %d\n", printf("13 stroka: %+8u\n", -123));
	 printf("kolichestvo %d\n", ft_printf("13 stroka: %+8u\n", -123));
	 printf("kolichestvo %d\n", printf("14 stroka: % +8u\n", -123));
	 printf("kolichestvo %d\n", ft_printf("14 stroka: % +8u\n", -123));
	 printf("kolichestvo %d\n", printf("15 stroka: %8.6u\n", 123));
	 printf("kolichestvo %d\n", ft_printf("15 stroka: %8.6u\n", 123));
	 printf("kolichestvo %d\n", printf("16 stroka: % 8.6u\n", 123));
	 printf("kolichestvo %d\n", ft_printf("16 stroka: % 8.6u\n", 123));
	 printf("kolichestvo %d\n", printf("17 stroka: %+ 8.6u\n", 123));
	 printf("kolichestvo %d\n", ft_printf("17 stroka: %+ 8.6u\n", 123));
	 printf("kolichestvo %d\n", printf("18 stroka: % 8.6 u\n", 123));
	 printf("kolichestvo %d\n", ft_printf("18 stroka: % 8.6 u\n", 123));
	 printf("kolichestvo %d\n", printf("19 stroka: %      8u\n", -123));
	 printf("kolichestvo %d\n", ft_printf("19 stroka: %      8u\n", -123));
	 printf("kolichestvo %d\n", printf("20 stroka: % 8.6u\n", 123));
	 printf("kolichestvo %d\n", ft_printf("20 stroka: % 8.6u\n", 123));
	 printf("kolichestvo %d\n", printf("21 stroka: % u\n", -123));
	 printf("kolichestvo %d\n", ft_printf("21 stroka: % u\n", -123));
	 printf("kolichestvo %d\n", printf("22 stroka: %      u\n", -123));
	 printf("kolichestvo %d\n", ft_printf("22 stroka: %      u\n", -123));
	 printf("kolichestvo %d\n", printf("23 stroka: %08.6u\n", 123));
	 printf("kolichestvo %d\n", ft_printf("23 stroka: %08.6u\n", 123));
	 printf("kolichestvo %d\n", printf("24 stroka: %-010u\n", 123));
	 printf("kolichestvo %d\n", ft_printf("24 stroka: %-010u\n", 123));
	 printf("kolichestvo %d\n", printf("25 stroka: % 010u\n", 123));
	 printf("kolichestvo %d\n", ft_printf("25 stroka: % 010u\n", 123));
	 printf("kolichestvo %d\n", printf("26 stroka: % 010.5u\n", 123));
	 printf("kolichestvo %d\n", ft_printf("26 stroka: % 010.5u\n", 123));
	 printf("kolichestvo %d\n", printf("27 stroka: %9.0u\n", 123));
	 printf("kolichestvo %d\n", ft_printf("27 stroka: %9.0u\n", 123));
	 printf("kolichestvo %d\n", printf("28 stroka: %9u\n", 123));
	 printf("kolichestvo %d\n", ft_printf("28 stroka: %9u\n", 123));
	 printf("kolichestvo %d\n", printf("29 stroka: % 08.6u\n", 123));
	 printf("kolichestvo %d\n", ft_printf("29 stroka: % 08.6u\n", 123));
	 printf("kolichestvo %d\n", printf("30 stroka: % 06u\n", 123));
	 printf("kolichestvo %d\n", ft_printf("30 stroka: % 06u\n", 123));
	 printf("kolichestvo %d\n", printf("%0+5u", 42));
	 printf("kolichestvo %d\n", ft_printf("%0+5u", 42));
=======
	printf("kolichestvo %d\n", printf("01 stroka: %-+8.6d\n", -123));
...
>>>>>>> b4c3a0d6d45ab7da3b81bcdddc169bc376707b40
    ...
    printf("kolichestvo %d\n", ft_printf("04 stroka: % -15p\n", str1));
<<<<<<< HEAD
    printf("kolichestvo %d\n", printf("05 stroka: % -015ppppp\n", str1));
    printf("kolichestvo %d\n", ft_printf("05 stroka: % -015ppppp\n", str1));

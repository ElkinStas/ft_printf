...
void    ft_checkmin(void* z, t_flist **base, long long *checkmin);
...
void    ft_checklongitude(void* z, t_flist **base, long long *checkmin)
{
    if (((*base)->spec == 1) && (*checkmin = (short) z))
          *checkmin  = (short)*checkmin ;
    else if (((*base)->spec  == 2) && (*checkmin = (long) z))
...
void	ft_loputnbrmin(void* z, t_flist **base, long long checkmin)
{
	long long y;
    unsigned long long a;
     if (((*base)->spec == 1) && (y = (short) z))
...
int main ()
{
 ...
 ft_printf("%d", ft_printf("@moulitest: %.d %.0d", 0, 0));
   // printf("%x", 5427);
   //printf("%d",printf("'%d'", q));
    //printf("%d",printf("\n%%"));

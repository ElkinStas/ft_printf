...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2019/04/10 17:54:00 by bhudson           #+#    #+#             */
/*   Updated: 2019/04/10 18:08:45 by bhudson          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void				ft_indentdchar(t_flist **base);
void				ft_loputnbrindentprint(t_flist *base,\
		int check, int checkmin);
void				ft_loputnbrindentu(void *z, t_flist *base, int *check);
void				ft_putsix(long long z, t_flist **base);
int					ft_print_float(int *count, long long per,\
		int *len, long double fl);
...
void				ft_checklongitudex(long long z, t_flist **base,\
		long long checkmin);
void				ft_loputnbrindentux(long long z, t_flist *base,\
		int *check);
